...
-- Schema murdock
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `murdock` DEFAULT CHARACTER SET utf8 ;
USE `murdock` ;

-- -----------------------------------------------------
-- Table `murdock`.`permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`permission` (
...
-- -----------------------------------------------------
-- Table `murdock`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`country` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `murdock`.`state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`state` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- Table `murdock`.`city`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`city` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_city_state1`
    ...
    REFERENCES `murdock`.`state` (`id` , `country_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- Table `murdock`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_user_permission`
    ...
    REFERENCES `murdock`.`permission` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_city1`
    FOREIGN KEY (`city_id` , `city_state_id` , `city_state_country_id`)
    REFERENCES `murdock`.`city` (`id` , `state_id` , `state_country_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- Table `murdock`.`areas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`areas` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `murdock`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`category` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `murdock`.`sub_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`sub_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_sub_category_category1`
    ...
    REFERENCES `murdock`.`category` (`id` , `areas_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `murdock`.`article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `murdock`.`article` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(45) NOT NULL,
